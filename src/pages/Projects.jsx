...
import ImgExpense from "../assets/expenseIMG.jpg"
...
const Projects = () => {
  return (
    <section>
      <h1 className="m mb-10 mt-4 p-3 text-center text-[25px] font-bold leading-[0.8] lg:mb-20 lg:mt-10 lg:text-[55px]">
        My Projects
      </h1>
          ...
          <div className="mt-2 w-60 text-center text-black lg:w-80">
            <p className="rounded-b-lg bg-orange-300 p-4 font-primary text-base font-bold">
              <span
                ...
                onClick={() =>
                  (window.location.href =
                    "https://frontend-g7t0.onrender.com/")
                }
              >
                Expense Tracker
                <br />
              ...
              <span className="hidden lg:inline">
                {" "}
                This MERN stack app lets users track expenses with Node.js, Express, MongoDB for the backend, and React for the frontend.
              </span>
            </p>
          </div>
        </div>
