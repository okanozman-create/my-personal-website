      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0">
          <div className="flex flex-1">
            <img
              className="h-[150px] w-[250px] -translate-y-4 rounded-xl transition-all duration-500 lg:h-[350px] lg:w-[450px] lg:hover:scale-125 lg:hover:rounded-full hidden lg:block"
              src={aboutImg}
              alt=""
          ...
          <motion.div
            ...
            className="flex-1"
          >
            <h1 className="mb-4 text-[30px] font-bold leading-[0.8] lg:text-[55px]">
              About me
            </h1>
            ...
            <div className="mb-12 flex gap-x-6 lg:gap-x-10">
              <div>
                <div className="text-gradient mb-2 font-tertiary text-[20px] lg:text-[50px] font-bold">
                  {inView ? <CountUp start={0} end={2} duration={5} /> : null}
                </div>
                <div className="font-primary font-bold md:text-3xl text-[20px] md:tracking-[2px]">
                  Years of <br />
                  Experience
                </div>
              </div>
